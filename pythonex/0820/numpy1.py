...
@author: GDJ24
0820/numpy1.py : numpy 기초
'''

import numpy as np   # python 에서 수치 계산을 위한 모듈

# 수치 리스트 생성하기
# np.array : 배열로 생성
print(np.array([1,4,2,5,3]))   # 리스트 값을 배열로
print(np.array([3.14,4,2,3]))  # 리스트 값을 실수형 배열
...
print(arr)
print(type(arr))   # numpy type

#  ones  : 1의 값을 가진 배열
arr = np.ones((3,5), dtype=float)  # 3행 5열 실수형 배열 생성. 1로 채움
print(arr)
...
# 평균 0, 표준편차 1인 정규분포를 따르는 3행 3열 난수 배열 생성
...
print(arr.shape)  # 배열의 구조
print(arr.size)   # 배열 요소의 갯수
